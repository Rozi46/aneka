...
class DataPenerimaan implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menugudang.exportdata.historypenerimaan',['url_api' => $url_api,'app' => 'penerimaanmenu','url_active' => 'penerimaanbarang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
