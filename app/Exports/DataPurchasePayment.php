...
class DataPurchasePayment implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menufinance.exportdata.historypembayaranhutang',['url_api' => $url_api,'app' => 'menupembayaranhutang','url_active' => 'historypembayaranhutang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
