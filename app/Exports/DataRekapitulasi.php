...
class DataRekapitulasi implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menufinance.exportdata.datarekapitulasi',['url_api' => $url_api,'app' => 'menufinance','url_active' => 'menuppn','request' => $request,'res_user' => $res_user,'listdata' => $results['results']]);
        }
    }
