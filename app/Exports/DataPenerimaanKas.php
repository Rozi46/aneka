...
class DataPenerimaanKas implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menufinance.exportdata.historypenerimaankas',['url_api' => $url_api,'app' => 'menupenerimaankas','url_active' => 'historypenerimaankas','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
