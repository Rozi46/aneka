...
class Jasa implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.masterdata.exportdata.datajasa',['url_api' => $url_api,'app' => 'masterdata','url_active' => 'listjasa','request' => $request,'res_user' => $res_user,'results' => $results['results']['listdata'],'listdata' => $results['results']]);
        }
    }
