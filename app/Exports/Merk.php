...
class Merk implements FromView
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.masterdata.exportdata.datamerk',['url_api' => $url_api,'app' => 'masterdata','url_active' => 'listmerk','request' => $request,'res_user' => $res_user,'results' => $results['results']['listdata'],'listdata' => $results['results']]);
        }
    }
}