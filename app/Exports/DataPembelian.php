...
class DataPembelian implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menupembelian.exportdata.historypembelian',['url_api' => $url_api,'app' => 'pembelianmenu','url_active' => 'pembelianbarang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
