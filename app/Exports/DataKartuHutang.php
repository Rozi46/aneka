...
class DataKartuHutang implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menufinance.exportdata.kartuhutang',['url_api' => $url_api,'app' => 'menufinance','url_active' => 'menuhutang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
