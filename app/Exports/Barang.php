...
class Barang implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.masterdata.exportdata.databarang',['url_api' => $url_api,'app' => 'masterdata','url_active' => 'listbarang','request' => $request,'res_user' => $res_user,'results' => $results['results']['listdata'],'listdata' => $results['results']]);
        }
    }
    ...
    public function columnFormats(): array
    {
        return [
            ...
            'I' => '#,##0.00', // Harga Jual
            'J' => '#,##0.00', // Harga Khusus
            'K' => '#,##0.00', // Harga Beli Tertinggi
            'M' => '#,##0.00', // Harga Beli Terakhir
        ];
    }
}