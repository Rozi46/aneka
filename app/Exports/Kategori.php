...
class Kategori implements FromView
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.masterdata.exportdata.datakategori',['url_api' => $url_api,'app' => 'masterdata','url_active' => 'listkategori','request' => $request,'res_user' => $res_user,'results' => $results['results']['listdata'],'listdata' => $results['results']]);
        }
    }
}