...
use App\Http\Controllers\ApiControllerGudang;
use Artisan;
use Cookie;
use JWTAuth;
...
class DataPenyesuaianStockBarang implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menugudang.exportdata.historypenyesuaianstockbarang',['url_api' => $url_api,'app' => 'menugudang','url_active' => 'penyesuaianstockbarang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
