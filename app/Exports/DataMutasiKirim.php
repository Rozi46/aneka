...
class DataMutasiKirim implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menugudang.exportdata.historymutasikirim',['url_api' => $url_api,'app' => 'menugudang','url_active' => 'mutasikirim','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
