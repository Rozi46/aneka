...
class AktivitasPengguna implements FromView
{
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.masterpengguna.exportdata.aktivitaspengguna',['url_api' => $url_api,'app' => 'users','url_active' => 'activityusers','request' => $request,'res_user' => $res_user,'results' => $results['results']]);
        }
    }
}