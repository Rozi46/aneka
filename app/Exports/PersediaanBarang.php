...
class PersediaanBarang implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menugudang.exportdata.persediaanbarang',['url_api' => $url_api,'app' => 'menugudang','url_active' => 'persediaanbarang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
