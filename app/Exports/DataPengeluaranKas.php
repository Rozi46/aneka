...
class DataPengeluaranKas implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menufinance.exportdata.historypengeluarankas',['url_api' => $url_api,'app' => 'menupengeluarankas','url_active' => 'historypengeluarankas','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
