...
class DataPenjualan implements FromView, WithColumnFormatting
{
    public $request;
    ...
    public function view(): View
    {
    	...
    	if(empty(session('key_token_aneka'))){
            ...
            return view('admin.AdminOne.menupenjualan.exportdata.historypenjualan',['url_api' => $url_api,'app' => 'penjualanmenu','url_active' => 'penjualanbarang','request' => $request,'res_user' => $res_user,'results' => $results['results']['list'],'listdata' => $results['results']]);
        }
    }
